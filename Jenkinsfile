...
node { 
    ...
    stage ('Initialize') {
        ...
        ansiblePlaybook extras: 'version=1.01.00 env=dev', installation: 'ansible', inventory: 'livraison/installation/inventory/dev2', playbook: 'livraison/installation/site.yml'
